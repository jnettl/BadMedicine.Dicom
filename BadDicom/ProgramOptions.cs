...
internal class ProgramOptions
{
    ...
    [Value(2, HelpText = "The number of dicom studies to generate", Default = 10)]
    ...
    [Option('p', "ExaminationPrefix", HelpText = "The string prefixing the patient ID and accession number")]
    public string ExaminationPrefix { get; set; } = string.Empty;
